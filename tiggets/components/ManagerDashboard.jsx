...
export default function ManagerDashboard({ role, tickets, session }) {
  // check if authorized
  ...
  const formattedTableTickets = tickets.map(t => ({
    ...
    username: t.username || t.createdByUsername || 'N/A',
    assignedTo: t.assignedTo || 'N/A',
    assignedToUsername: t.assignedToUsername || 'N/A',
  ...
  return (
    <div className="w-full font-text text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 min-h-55 border border-zinc-200 flex flex-col">
      ...
      <div className="w-full">
        <h2 className="text-xl font-bold mb-4">Your Assigned Tickets</h2>
        <TicketList
          role={role}
          tickets={formattedTableTickets}
        />
      </div>
